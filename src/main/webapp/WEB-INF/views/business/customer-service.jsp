		...
		<div class="ui segment attached">
			...
			<div class="ui segment">
				...
				<div style="margin-top: 10px;">
					<form action="business/listService.do" method="post"
						id="filter-form"></form>
					<a class="ui label" id="czsStatus-1" onclick="filterHandler('1')"
						style="margin-top: 5px; margin-bottom: 5px;"> 新请求 ${newCount}
						个 </a> <a class="ui label" id="czsStatus-0"
						...
						<tr id="item-tr-${item.id}" class="item-tr-${item.id}">
							...
							<td class="" data-sort-value="${item.handler_name}"><c:if
									...
									<img class="ui avatar image"
										src="${item.handler_headimgurl}/64">${item.handler_name}(${item.handler_sex})</c:if></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
