			...
			<form action="business/update.do">
				...
				<div data-role="fieldcontain">
					<label for="textinput1"> 商家名称 </label> <input name="name"
						id="textinput1" placeholder="" value="${business.name }" type="text">
				</div>
				<div data-role="fieldcontain">
					<label for="textinput2"> 商家地址 </label> <input name="address"
						id="textinput2" placeholder="" value="${business.address }" type="text">
				</div>
				<div data-role="fieldcontain">
					<label for="textinput3"> E-mail </label> <input name="mail"
						id="textinput3" placeholder="" value="${business.mail }" type="email">
				</div>
				<div data-role="fieldcontain">
