...
<body style="margin: 0px; padding: 0px;">
	...
	<div class="ui left vertical menu thin sidebar">
		...
		<a class="item" href="user/free/businessStow.do?openId=${openId}"
			...
			href="user/free/foodStow.do?openId=${openId}"
			id="menu-item-food-stow">美食收藏</a>
		<div class="header item">
		...
		<div class="header item">
			<i class="user icon"></i> 订单查询
		</div>
		<a class="item"
			href="menu/free/billQuery.do?status=1&isOwn=1&consumerId=${openId}"
			id="menu-item-confirm-bill"> 已下订单</a> <a class="item"
			href="menu/free/billQuery.do?status=0&isOwn=1&consumerId=${openId}"
			id="menu-item-hold-bill"> 待定订单</a>
	</div>
